...
\begin{tikzpicture}
  ...
  \node[anchor=south west, inner sep=0pt] (ctrl) at (0,0)
    {\includegraphics[width=\imagewidth]{Logitech_JoyPad_picture.png}};

  % ---- Left-side controls ----
  \coordinate (leftTrigger)   at (4.8, 8.5);   % Left trigger  (LT / L2)
  \coordinate (leftShoulder)  at (2.8, 7.5);   % Left bumper   (LB / L1)
  ...
  \joyCallout{leftTrigger}   {-5.0,  1.5} {Left Trigger\\\textbf{Zoom In}}
